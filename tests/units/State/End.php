...
use Rezzza\Workflow\State\All as TestedClass;
use Rezzza\Workflow\Workflow;
use Rezzza\Workflow\tests\fixtures\Item;
use mageekguy\atoum;

class All extends atoum\test
{
    public function dataProviderIsAllow()
    {
        return array(
            // no specification
            array(array(1, 1, 1), 'state1', array('state2', 'state3')),
            array(array(1, 1, 1), 'state2', array('state1', 'state3')),
            array(array(1, 1, 1), 'state3', array('state1', 'state2')),
            // specification
            array(array(1, 0, 1), 'state1', array('state3')),
            array(array(1, 0, 1), 'state2', array('state1', 'state3')),
